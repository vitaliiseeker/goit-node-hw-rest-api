...
```
*Примітка: Пароль повинен складатися з букв латинського алфавіту (A-z), арабських цифр (0-9) і спеціальних символів, літерна частина пароля повинна містити як малі, так і великі букви, довжина пароля повинна бути не менше 8 і не більше 16 символів.*
