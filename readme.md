...
**Приклад відповіді:** не правильний `"password"`
...
**Приклад вмісту запиту** для контакту з ідентифікатором `"_id" - "63a512a69d819e19947d0a4f"` в базі даних
...
**Приклад відповіді:** для запиту контакта з ідентифікатором `"_id" - "6393def55e1f48171bfecbe"`, не відповідає дійсному шаблону ідентифікатора mongo
